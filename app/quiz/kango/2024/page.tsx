...
import amQuestions from "@/data/questions/kango/2024/am/questions.json";
import pmQuestions from "@/data/questions/kango/2024/pm/questions.json";
import amMeta from "@/data/questions/kango/2024/am/meta.json";
import pmMeta from "@/data/questions/kango/2024/pm/meta.json";
...
export default async function Kango2024Page({ searchParams }: PageProps) {
    ...
    <main className="mx-auto w-full max-w-400 px-4 py-4">
      <div className="mb-4 rounded-2xl border border-black/10 bg-white p-3 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            href="/quiz/kango/2024?session=am"
          ...
          <Link
            href="/quiz/kango/2024?session=pm"
            className={`inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium transition ${
              session === "pm"
                ? "bg-sky-600 text-white shadow"
                : "bg-slate-100 text-slate-700 hover:bg-slate-200"
